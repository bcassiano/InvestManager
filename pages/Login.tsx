            ...
            <div className="max-w-md w-full bg-surface-light dark:bg-surface-dark rounded-xl shadow-lg border border-slate-200 dark:border-border-dark overflow-hidden">
                <div className="p-8">
                    <div className="flex flex-col items-center mb-8 gap-2">
                        ...
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white">Bem-vindo de volta</h2>
                        <p className="text-slate-500 dark:text-text-secondary text-center text-sm">Insira seus dados para acessar o InvestManager</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex justify-between items-center">
                                ...
                                <a href="#" className="text-xs font-bold text-primary hover:text-primary-hover">Esqueceu a senha?</a>
                            </div>
                            <div className="relative">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-slate-500 dark:text-text-secondary">
                            Não tem uma conta? <Link to="/signup" className="font-bold text-primary hover:text-primary-hover">Crie agora</Link>
                        </p>
                    </div>
                </div>
            </div>
